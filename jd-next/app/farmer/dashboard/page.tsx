  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          { label:"Active Listings",  value: activeCount,               icon:"Listings" },
          { label:"Total Orders",     value: orders.length,             icon:"Orders" },
          { label:"Revenue Earned",   value:`Rs${totalRevenue.toFixed(0)}`, icon:"Revenue" },
          { label:"Pending Dispatch", value: pendingOrders,             icon:"Pending" },
        ].map(s=>(
                        ...
                        <div className="flex items-center gap-3">
                          <div className="w-14 h-14 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                            {img ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center text-sm text-gray-400">No img</div>
                            )}
                          </div>
                          <div className="flex-1 min-w-0">
                            ...
                            {!isEditing ? (
                              <p className="text-xs text-gray-500 mt-0.5">
                                Rs{Number(p.price_per_unit).toFixed(2)}/{p.unit} - {p.available_qty} {p.unit} in stock
                              </p>
                            ) : (
                              <p className="text-xs text-green-600 mt-0.5">Editing - update price and stock below</p>
                            )}
                          </div>
                        ...
                        {isEditing && (
                          <div className="mt-3 pt-3 border-t border-gray-100">
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              <div>
                                <label className="text-xs text-gray-500 font-medium block mb-1">Stock ({p.unit} available)</label>
                            ...
                            <p className="text-xs text-gray-400 mt-2 text-center">
                              Price and stock update instantly.
                            </p>
                          </div>
                        )}
                      </div>
